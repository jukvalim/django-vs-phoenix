defmodule EventsPhoenixWeb.EventLiveTest do
  use EventsPhoenixWeb.ConnCase

  import Phoenix.LiveViewTest
  import EventsPhoenix.EventsFixtures

  @create_attrs %{description: "some description", end_time: %{day: 20, hour: 20, minute: 13, month: 11, year: 2021}, name: "some name", start_time: %{day: 20, hour: 20, minute: 13, month: 11, year: 2021}}
  @update_attrs %{description: "some updated description", end_time: %{day: 21, hour: 20, minute: 13, month: 11, year: 2021}, name: "some updated name", start_time: %{day: 21, hour: 20, minute: 13, month: 11, year: 2021}}
  @invalid_attrs %{description: nil, end_time: %{day: 30, hour: 20, minute: 13, month: 2, year: 2021}, name: nil, start_time: %{day: 30, hour: 20, minute: 13, month: 2, year: 2021}}
