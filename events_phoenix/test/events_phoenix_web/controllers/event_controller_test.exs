defmodule EventsPhoenixWeb.EventControllerTest do
  use EventsPhoenixWeb.ConnCase

  import EventsPhoenix.EventsFixtures

  @create_attrs %{description: "some description", end_time: ~U[2021-11-20 17:21:00Z], name: "some name", start_time: ~U[2021-11-20 17:21:00Z]}
